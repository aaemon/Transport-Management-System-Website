...
Thank you';
        ...
        header("Location: ../sub_admin_rejected_personal_forms.php?form=deleted");
        exit();
        }
...
Thank you';
    ...
    $header = 'From: transport.cuetwebprojects.com'; 
    mail($to, $subject, $message_body, $header);
    header("Location: ../sub_admin_accepted_personal_forms.php?form=accepted");
    exit(); 
        ...
        $sql = "UPDATE personal_req SET status = '$status' WHERE form_no = '$form_no';";
        mysqli_query($conn, $sql);
        header("Location: ../sub_admin_personal_forms.php?form=pending");
        exit();
